...
int main(){
  ...
  scout -> attack(priest);
  /*std::cout << "Priest position: " << priest->getCoord() << std::endl;

  std::vector<Coordinate> coor1;
  coor1 = priest -> getMoveableCoordinates();
  std::cout << "Priest moveable coordinates: {" ;
  for (auto& d : coor1){
    std::cout << d << " ";
  }
  std::cout << "}" << std::endl;
  */
  ...
  std::vector<Coordinate> coor2;
  coor2 = scout->getMoveableCoordinates();
    std::cout << "Scout moveable coordinates: {" ;
  for (auto& e : coor2){
    std::cout << e << " ";
  }
  std::cout << "}" << std::endl;
