...
# It is similar to seq
# Actually, I directly did from seq-full.hcl part
# 
#	Fetch:
#	icode : ifun <- M1[PC]
#	rA : rB <- M1[PC+1]
#	valA <- M8[PC+2]   # it implies valC since in advance, it set aluA to valC
#	valP <- PC + 10
#
#	Decode:
#	valB <- R[rB]
#
#	Execute:
#	valE <- valB + valA #valA implies valC
#
#	Memory:	
#
#	WriteBack:
...
bool set_cc = E_icode in {IOPQ, IIADDQ} &&  	#------------------	E_code == IOPQ && 
