...
class Client(Thread):
	...
	def clientFunction(self):
		...
		local_sock.settimeout(0.1) #important for resending

		while stillRunning : 
			try:
				with clientAccessLock:
					#with lock , check if other thread has finished
				...
				with clientAccessLock:
					#with lock , if last one of the ack is lost client doesn't send that ack again, time sender out
...
if __name__ == "__main__":
	...
	targetAddresses = ['10.10.4.2','10.10.5.2']
