...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Lab ismailAbi = new Lab("ismailAbi", 10);
        Lab dijital = new Lab("dijital", 10);
        Lab mera = new Lab("mera", 10);
        ...
        StudyGroup konuskan = new StudyGroup("aniran", mera);
        StudyGroup oyuncu = new StudyGroup("oyuncu", mera);

        StudyGroup[] studyGroups = {quietOnes,ruleBreakers,seniorProjectProgrammers,slackers, konuskan, oyuncu};
